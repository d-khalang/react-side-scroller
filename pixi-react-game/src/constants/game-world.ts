...
export const DEFAULT_POS_Y = TILE_SIZE * 5
...
export const ANIMATION_SPEED = 0.2; // Speed of animation (adjust as needed)
export const ZOOM = 2; // Zoom level for the camera